...
class ROSE(data.Dataset):
    ...
    def get_dataPath(self, root, isTraining):
        ...
        if isTraining:
            img_dir = os.path.join("./data/ROSE-1/SVC_DVC/train/img")
            gt_dir = os.path.join("./data/ROSE-1/SVC_DVC/train/gt")
            deep_dir = os.path.join("./data/ROSE-1/SVC/train/thin_gt")
            superficial_dir = os.path.join("./data/ROSE-1/SVC/train/thick_gt")
        else:
            img_dir = os.path.join("./data/ROSE-1/SVC_DVC/test/img")
            gt_dir = os.path.join("./data/ROSE-1/SVC_DVC/test/gt")
            deep_dir = os.path.join("./data/ROSE-1/SVC/test/thin_gt")
            superficial_dir = os.path.join("./data/ROSE-1/SVC/test/thick_gt")
...
#         """
#         if isTraining:
#             img_dir = os.path.join("E:/OCTASNet/code/data/ROSE-2/train/original")
#             gt_dir = os.path.join("E:/OCTASNet/code/data/ROSE-2/train/gt")
#         else:
#             img_dir = os.path.join( "E:/OCTASNet/code/data/ROSE-2/test/original")
#             gt_dir = os.path.join("E:/OCTASNet/code/data/ROSE-2/test/gt")
